...
int pipeline_tbb(image_dir_t* image_dir) {
    ...
    parallel_pipeline(192, 
        make_filter<void, image_t*>(tbb::filter::serial_out_of_order, [&](tbb::flow_control& fc) -> image_t* {
                image_t* image;
        ...
        & make_filter<image_t*, void>(tbb::filter::serial_out_of_order, [&](image_t* image) {
